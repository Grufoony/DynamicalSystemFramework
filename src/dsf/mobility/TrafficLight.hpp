...
namespace dsf::mobility {
  ...
  public:
    ...
    explicit TrafficLightPhase(Delay duration) : m_duration{duration} {}

    /// @brief Construct a phase with a duration and a pre-built green set.
    TrafficLightPhase(Delay duration,
    ...
    bool containsGreen(Id streetId, Direction direction) const {
    ...
    inline void setDuration(Delay d) { m_duration = d; }

...
namespace dsf::mobility {
  ...
  enum class AgentInsertionMethod : std::uint8_t {
    ...
    UNIFORM = 3,  // Agents spawn uniformly directly onto available edges (streets)
    CONDITIONAL_RANDOM_ODS =
        4,  // Agents are generated by randomly selecting their origin according to the weights, then randomly selecting their destination according to the conditional weights
  };
